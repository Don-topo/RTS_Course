...
public class Grenadier : BaseMilitaryUnit
{
    ...
    protected override void Awake()
    {
        ...
        {
            Debug.LogError($"Grenadier {name} is missing a grenade or explosion particles!");
            return;
        }
    ...
    public void OnThrowGrenade()
    {
        ...
        Vector3 endPosition = grenade.transform.position + grenadeParent.transform.forward * 3;
    ...
    private void ApplyDamage(Vector3 endPosition, IDamageable damageable)
    {
        ...
        if (unitSO.AttackConfig.IsAreaEffect)
        {
            int hits = Physics.OverlapSphereNonAlloc(
                endPosition,
                unitSO.AttackConfig.AreaOfEffectRadius,
                enemyColliders,
                unitSO.AttackConfig.DamageableLayer
            );
